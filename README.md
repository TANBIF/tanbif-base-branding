...
git clone --recurse-submodule https://github.com/TANBIF/tanbif-base-branding.git
...
```
brunch build --production && rsync -a --delete --info=progress2 public/ tanbif-base:/srv/tanbif.costech.or.tz/www/tz-ui-2020/
